...
<body>
    <section class="header">
        <div class="page">
            <img src="../pics/clg.png" class="page">
            <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Project Submission System</h1>               
        </div>
        <form method='post'>
        <div class="container">
        <div class="col-2">
                <img src="../pics/pic6.jpg" class="student" align="right">
         </div>
    <div class="custom-select">
        <h2>Project-id:</h2>
        <input class="text" type="text" name="ID" id="ID" placeholder="Format:ISE-XXX" pattern="[A-Z]{3}[-]{1}[0-9]{3}" size="15" required><br>
        <h2>Semester:</h2>
